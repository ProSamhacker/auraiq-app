...
export const BotIcon: FC<SVGProps<SVGSVGElement>> = (props) => (
...
// ... (keep all your other existing icons) ...

export const BrainIcon: FC<SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M12 7v10" />
    <path d="M17.8 9.2a2.5 2.5 0 0 1 0 5.6" />
    <path d="M6.2 9.2a2.5 2.5 0 0 0 0 5.6" />
    <path d="M14 17h-4" />
    <path d="M16 22a2.5 2.5 0 0 0-8 0" />
  </svg>
);
...
// ... (keep all your existing icons: BotIcon, UserIcon, etc.) ...
